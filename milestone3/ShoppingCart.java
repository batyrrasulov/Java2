...
import milestone3.ShoppingCart;

public abstract class ShoppingCart {
	//Shopping Cart Products gets Steel Dagger and Executioner Axe customer wishes to purchase from StoreFront
		...
		static void viewShoppingCart() {
			...
			if (selection == 1) 
				...
				InventoryManager.returnSteelDagger(steelDaggersInCart);
				InventoryManager.returnExecutionerAxe(executionerAxesInCart);
				InventoryManager.returnTannedLeather(tannedLeathersInCart);
				InventoryManager.returnSteeler(steelersInCart);
				InventoryManager.returnAdd100(add100InCart);
				InventoryManager.returnAdd250(add250InCart);
